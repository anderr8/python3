...
# Básica
# https://regex101.com/r/eOYynL/1
# "^\w+(?:[.\-+!%]\w+)*@\w+(?:[.\-]\w+)+$"gm

# Básica 2
# ^[^\s@<>\(\)[\]\.]+(?:\.[^\s@<>\(\)\[\]\.]+)*@\w+(?:[\.\-_]\w+)*$
# https://regex101.com/r/Grt5KT/1
...
this\ stillz"not\\allowed@example.com
plainaddress
#@%^%#$@#$@#.com
@example.com
<email.example.com>
...
"(),:;<>[\]@example.com
just"not"right@example.com
this\ is"really"not\allwed@exqample.com
"""